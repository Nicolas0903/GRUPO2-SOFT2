...
const RegisterPage1 = () => {
  ...
  const handleSubmit = (event) => {
    ...
    localStorage.setItem('newUser', JSON.stringify({ nombres, apellidos }));
    navigate('/register2');
  };
  ...
  return (
    <Container className="ContenedorPrincipalRegistro" maxWidth="xs">
      <Grid container direction="column" alignItems="center">
        <Typography variant="h5" className="TituloRegistro" fontSize="38px" align="center" gutterBottom>
          <b>Registro de Usuario</b>
        </Typography>
        <Typography variant="subtitle1" className="SubtituloRegistro" color="white" align="justify" gutterBottom>
          Datos Personales
        </Typography>
      </Grid>
